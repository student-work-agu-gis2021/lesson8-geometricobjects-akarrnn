...
def create_point_geom(x_coode,y_coode):
  """this function create a object and return that"""
...
def create_line_geom(points):
  """Create a function that takes a list of Shapely Point objects as parameter."""
...
def get_centroid(geom):
  """geom is caculate centroid"""
  assert type(geom)==Point or type(geom)==LineString or type(geom)==Polygon, "Input should be a list!"
